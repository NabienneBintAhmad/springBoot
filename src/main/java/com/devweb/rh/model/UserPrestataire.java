...
public class UserPrestataire {
    ...
    public UserPrestataire(String matriculee, String nom, String prenomm, String adressee, String contactt, String emaill, int cnii) {
